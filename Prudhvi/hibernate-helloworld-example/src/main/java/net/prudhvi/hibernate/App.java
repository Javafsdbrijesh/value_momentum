package net.prudhvi.hibernate;

import org.hibernate.Session;
import org.hibernate.Transaction;

import net.prudhvi.hibernate.entity.Customer;
import net.prudhvi.hibernate.entity.Student;
import net.prudhvi.hibernate.util.HibernateUtil;
