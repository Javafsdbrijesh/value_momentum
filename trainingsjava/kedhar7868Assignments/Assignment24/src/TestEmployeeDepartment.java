...
import java.util.List; public class TestEmployeeDepartment {
    public static void main(String[] args) {         Department account = new Department("Account", 75); 
        Department hr = new Department("HR", 50);
        Department ops = new Department("OP", 25);
        Department tech = new Department("Tech", 150);            List<Employee> employeeList = Arrays.asList(
                ...
                new  Employee("Rohith", 31, "Noida", hr));         //Find all employees who lives in ‘Noida’ city.
